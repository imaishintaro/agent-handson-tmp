...
if (!DISCORD_TOKEN || !CLIENT_ID) {
    console.error("エラー: DISCORD_TOKEN と DISCORD_CLIENT_ID を設定してください");
    process.exit(1);
}
// スラッシュコマンドの定義
const commands = [
    ...
    new discord_js_1.SlashCommandBuilder()
        ...
        .setRequired(true)
        .addChoices({ name: "Sonnet (高速・バランス型)", value: "anthropic/claude-sonnet-4-20250514" }, { name: "Opus (最高性能)", value: "anthropic/claude-opus-4-20250514" }, { name: "Haiku (最速・軽量)", value: "anthropic/claude-haiku-4-5-20251001" })),
